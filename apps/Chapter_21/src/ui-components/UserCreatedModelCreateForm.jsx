...
export default function UserCreatedModelCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new UserCreatedModel(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "UserCreatedModelCreateForm")}
      {...rest}
    >
      <ArrayField
